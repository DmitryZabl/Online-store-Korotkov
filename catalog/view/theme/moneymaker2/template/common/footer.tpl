  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-sm-6 col-md-3">
        <div class="h5 text-muted"><i class="fa fa-fw fa-file-text-o"></i> <?php echo $text_information; ?></div>
      ...
      <div class="col-sm-6 col-md-3">
        <div class="h5 text-muted"><i class="fa fa-fw fa-commenting-o"></i> <?php echo $text_service; ?></div>
        <ul class="list-unstyled">
      ...
      <div class="col-sm-6 col-md-3">
        <div class="h5 text-muted"><i class="fa fa-fw fa-folder-o"></i> <?php echo $text_extra; ?></div>
        <ul class="list-unstyled">
      ...
      <div class="col-sm-6 col-md-3">
        <div class="h5 text-muted"><i class="fa fa-fw fa-envelope-open-o"></i> <?php echo $moneymaker2_modules_newsletter_header; ?></div>
        <ul class="list-unstyled">
