      ...
      <div class="row">
        ...
        <div class="<?php //echo $class; ?> col-sm-12">
          ...
          <div class="row">
            ...
            <div class="col-sm-12 col-md-6">
              ...
              <div id="product" itemprop="offers" itemscope itemtype="https://schema.org/Offer">
                ...
                <link itemprop="url" href="<?php echo end($breadcrumbs)['href']; ?>" content="<?php echo end($breadcrumbs)['href']; ?>" property="" />
                <?php if ($reward) { ?>
          ...
          <ul class="nav nav-tabs text-center">
            <?php if ($description) { ?>
            <li class="active"><a href="#tab-description" data-toggle="tab"><i class="fa fa-fw fa-file-text-o"></i> <?php echo $tab_description; ?></a></li>
            <?php } ?>
            ...
            <?php if ($value['link']) { ?>
            <li><a href="#tab-additional-<?php echo $key; ?>" data-toggle="tab"><i class="fa fa-fw fa-<?php echo $value['icon']; ?>"></i> <?php echo $value['name']; ?></a></li>
            <?php } ?>
            <?php } ?>
            <?php } ?>
          </ul>
            ...
            <div class="tab-pane fade<?php if ($moneymaker2_product_tabs_hide||!$description) { ?> in active<?php } ?>" id="tab-specification">
              ...
              <div class="<?php if ($moneymaker2_product_tabs_attributes_responsive) { ?>table-responsive<?php } ?>">
                <table class="table table-hover">
                  ...
                  <tbody>
                    <tr>
                      <th colspan="2" class="text-center"><?php echo $attribute_group['name']; ?></th>
                    </tr>
                  </tbody>
                  <tbody>
                  ...
                  <tbody>
                  <tr>
                    <th colspan="2" class="text-center"><?php echo $text_product; ?></th>
                  </tr>
                  </tbody>
                  <tbody>
