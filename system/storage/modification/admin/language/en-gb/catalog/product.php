<?php
                    ...
                    // AP TABS 
                    $_['text_ap_title']             = 'Названия вкладки (Поддерживает HTML)';
                    $_['text_ap_add']               = 'Добавить вкладку';
                    $_['text_ap_tabs']              = 'Дополнительные вкладки';
                    $_['text_ap_sort']              = 'Сортировка';
                    $_['text_tab_cross_on']         = "Для всех товаров";
                    $_['text_tab_cross_off']        = "Для этого товара"; 

                    $_['error_ap_tab_name']         = 'Поле "Название вкладки" должно быть заполнено. Допустимое количество от 3х до 255 символов!';
                    $_['error_ap_tab_content']      = 'Нет контента! Поле с контентом должно быть заполнено!';
