        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-design" data-toggle="tab"><?php echo $tab_design; ?></a></li>
                    ...
                    <!-- AP TABS -->
                    <li><a href="#tab-ap-tabs" data-toggle="tab"><?echo $text_ap_tabs; ?></a></li> 
              ...
              <div class="table-responsive">
                <table class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <!-- AP TABS -->
                    <div class="tab-pane" id="tab-ap-tabs">
                        <div class="row">
                            <div class="col-sm-12">
                                <p class="alert alert-info">
                                   { AP } Tabs (Автор::<a rel="nofollow noopener" target="_blank" href="https://opencartforum.com/user/674600-artempitov/" title="Написать автору">Artem Pitov</a>) 
                                    <button type='button' class='close' data-dismiss='alert'>×</button>
                                </p>
                            </div>
                            
                            <?php $m_row = 1; $tab_row = 1; ?>

                            <div class="col-sm-2">
                                <ul class="nav nav-pills nav-stacked">
                                    <?php foreach ($ap_tabs as $tab) { ?>
                                    <li>
                                        <div class="btn-ap-group">
                                            <a data-toggle="tab" class="btn" href="#tab-<?= $m_row; ?>">TAB #<?= $m_row; ?></a>
                                            <a onClick="$('#tab-<?= $m_row; ?>').remove(); $('a[href=\'#tab-<?= $m_row; ?>\']').parent().parent().remove();" class="btn"> 
                                                <i class="fa fa-times" aria-hidden="true"></i> 
                                            </a>
                                        </div>
                                    </li>    
                                    <?php $m_row++; } ?>               
                                    <li id="m-footer"><button type="button" class="btn btn-danger btn-block" onClick="addTab(); return false;"><?= $text_ap_add; ?></button></li>
                                </ul>
                            </div>
                    
                            <div class="col-sm-10">
                                <div id="ap-t-content" class="tab-content">
                                    <?php foreach ($ap_tabs as $tab) { ?>
                                    <div id="tab-<?= $tab_row; ?>" class="tab-pane fade">
                                        <ul class="nav nav-tabs tbs-ap">
                                            <?php foreach ($languages as $language) { ?> 
                                            <li> 
                                                <a data-toggle="tab" href="#language-<?= $language['language_id'] . '-' . $tab_row; ?>" >
                                                <?php if ($version == '2.1') { ?>
                                        ...
                                        <div class="tab-content tbs-ap-cont">

                                            <div class="form-group" style="padding:0">
                                                <label class="switch">
                                                    <input type="checkbox" class="switch-input" <?= isset($tab['cross']) ? 'checked' : ''; ?>
                                                        name="ap_tabs[<?= $tab_row; ?>][cross]" value="1">
                                                    <span class="switch-label" data-on="<?= $text_tab_cross_on; ?>" data-off="<?= $text_tab_cross_off; ?>"></span> 
                                                    <span class="switch-handle"></span> 
                                                </label>
                                            </div> 

                                            <?php if (isset($tab['cross'])) {
                                                unset($tab['cross']);
                                            } ?>                                                                                        
                                            
                                            <?php foreach ($languages as $language) { ?> 
                                            <div id="language-<?= $language['language_id'] . '-' . $tab_row; ?>" class="tab-pane fade">  

                                                <?php if (!empty($error_ap_tabs_name[$tab_row][$language['language_id']])) { 
                                                    echo "<div class='alert alert-danger'><i class='fa fa-paw' aria-hidden='true'></i> {$error_ap_tabs_name[$tab_row][$language['language_id']]}
                                                    <button type='button' class='close' data-dismiss='alert'>×</button> </div>"; 
                                                } ?>
                                                <?php if (!empty($error_ap_tab_content[$tab_row][$language['language_id']])) {
                                                    echo "<div class='alert alert-danger'> <i class='fa fa-paw' aria-hidden='true'></i> 
                                                    {$error_ap_tab_content[$tab_row][$language['language_id']]}
                                                    <button type='button' class='close' data-dismiss='alert'>×</button> </div>"; 
                                                } ?>
                                                <div class="input-group">
                                                    <span class="input-group-addon"><?= $text_ap_title; ?></span>
                                                    <input type="text" class="form-control" name="ap_tabs[<?= $tab_row; ?>][<?= $language['language_id']; ?>][name]"  
                                                        value="<?= $tab[$language['language_id']]['name']; ?>">
                                                </div>                                                
                                                <div class="form-group">
                                                    <div class="col-sm-12">
                                                        <textarea id="textarea-r-<?= $tab_row; ?>-l-<?= $language['language_id']; ?>" class="tt-ap-tabs form-control" name="ap_tabs[<?= $tab_row; ?>][<?= $language['language_id']; ?>][content]"><?= $tab[$language['language_id']]['content']; ?></textarea> 
                                                    </div>
                                                </div>
                                                <div class="input-group col-sm-3">
                                                    <span class="input-group-addon"><?= $text_ap_sort; ?></span>
                                                    <input class="form-control" type="text" name="ap_tabs[<?= $tab_row; ?>][<?= $language['language_id']; ?>][sort_order]"
                                                        value="<?= $tab[$language['language_id']]['sort_order']; ?>">
                                                </div>                            
                                            </div>
                                            <?php } ?>
                                        </div>
                                            ...
                                            <?php foreach ( $languages as $language ) { ?> 
                                                <?php if ( isset($ckeditor) && $ckeditor ) { ?> 
                                                    if (typeof ckeditorInit == 'function') {
                                                        ckeditorInit('textarea-r-<?= $tab_row; ?>-l-<?= $language['language_id']; ?>', '<?= $token; ?>');
                                                    }
                                                <?php } else { ?> 
                                                    initSummernote(<?= $language['language_id']; ?>, <?= $tab_row; ?>); 
                                                <?php } ?>
                                            <?php } ?>
                                        $('#tab-<?= $tab_row; ?> a:first').tab('show');
                                      });
                                    </script>
                    ...
                    <script> 
                        ...
                        function addTab () {
                            ...
                            menu  = '<li>';
                            menu +=     '<div class="btn-ap-group">';
                            menu +=         '<a data-toggle="tab" class="btn" href="#tab-'+ m_row + '"> TAB #'+ m_row +'</a>';
                            menu +=         '<a onClick="$(\'#tab-'+ m_row +'\').remove(); $(\'a[href=\\\'#tab-'+ m_row +'\\\']\').parent().parent().remove(); $(\'#tab-ap-tabs .nav-stacked a[data-toggle=\\\'tab\\\']:first\').tab(\'show\');" class="btn"> <i class="fa fa-times" aria-hidden="true"></i> </a>';
                            menu +=     '</div></li>';

                            html =  '<div id="tab-' + m_row +'" class="tab-pane fade">';
                            html +=     '<ul class="nav nav-tabs tbs-ap">';

                            <?php foreach ($languages as $language) { ?> 
                            html +=         '<li> <a data-toggle="tab" href="#language-<?= $language['language_id']; ?>-'+ m_row +'">'; 

                            <?php if ($version == '2.1') { ?>
                            html +=             '<img src="view/image/flags/<?= $language['image']; ?>" />'; 
                            <?php } else { ?>
                            html +=             '<img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" />';
                            <?php } ?>
                            ...
                            html +=     '</ul>';
                            html +=     '<div class="tab-content tbs-ap-cont">';
                            html +=         '<div class="form-group" style="padding:0">';
                            html +=         '   <label class="switch">';
                            html +=         '       <input type="checkbox" class="switch-input" name="ap_tabs['+ m_row +'][cross]" value="1">';
                            html +=         '       <span class="switch-label" data-on="<?= $text_tab_cross_on; ?>" data-off="<?= $text_tab_cross_off; ?>"></span>';
                            html +=         '       <span class="switch-handle"></span>'; 
                            html +=         '   </label>';
                            html +=         '</div>';
                                            <?php foreach ($languages as $language) { ?> 
                            html +=         '<div id="language-<?= $language['language_id']; ?>-'+ m_row +'" class="tab-pane fade">';  
                            html +=             '<div class="input-group">';
                            html +=                 '<span  class="input-group-addon"><?= $text_ap_title; ?></span>';
                            html +=                 '<input class="form-control" type="text" name="ap_tabs['+ m_row +'][<?= $language['language_id']; ?>][name]">';
                            html +=             '</div>'; 
                            html +=             '<div class="form-group">'; 
                            html +=                 '<div class="col-sm-12"> <textarea id="textarea-r-'+ m_row +'-l-<?= $language['language_id']; ?>" class="tt-ap-tabs form-control" name="ap_tabs['+ m_row +'][<?= $language['language_id']; ?>][content]"></textarea> </div>';
                            html +=             '</div>';
                            html +=             '<div class="input-group col-sm-3">';
                            html +=                 '<span class="input-group-addon"><?= $text_ap_sort; ?></span>';
                            html +=                 '<input class="form-control" type="text" name="ap_tabs['+ m_row +'][<?= $language['language_id']; ?>][sort_order]">';
                            html +=             '</div>';
                            html +=         '</div>';
                                            <?php } ?>
                            html +=     '</div>';
                            ...
                            $('#m-footer').before(menu);
                            $('#ap-t-content').append(html); 
                            $('a[href="#tab-'+ m_row + '"]').tab('show');
                            $('#tab-' + m_row +' a:first').tab('show');

                            <?php foreach ($languages as $language) { ?> 
                                <?php if ( isset($ckeditor) && $ckeditor ) { ?>
                                    if (typeof ckeditorInit == 'function') {
                                        ckeditorInit('textarea-r-'+ m_row +'-l-<?= $language['language_id']; ?>', '<?= $token; ?>'); 
                                    }
                                <?php } else { ?>
                                    initSummernote(<?= $language['language_id']; ?>, m_row);
                                <?php } ?>
                            <?php } ?>
                        ...
                        $('#tab-ap-tabs ul a:first').tab('show');

                        function initSummernote (lang_id, id) 
                        {

                            $('#textarea-r-'+ id +'-l-'+ lang_id).summernote({
                                disableDragAndDrop: true,
                                height: 300,
                                lang: '<?= isset($lang) ? $lang : 'en-US'; ?>',
                                emptyPara: '',
                                toolbar: 
                                [
                                    ['style', ['style']],
                                                    ...
                                                    $.ajax({
                                                        ...
                                                        success: function(html) 
                                                        {
                                                            ...
                                                            $('#modal-image').delegate('a.thumbnail', 'click', function(e) {
                                                                ...
                                                                $('#textarea-r-'+ id +'-l-'+ lang_id).summernote('insertImage', $(this).attr('href'));        
                    ...
                    <style>
                    .btn-ap-group { display: table; width: 100%;}
                    .btn-ap-group a {display: table-cell;color:#f9f9f9;border-top:1px solid #1978AB;border-bottom: 1px solid #1978AB;background: #1E91CF;-webkit-transition: all .2s ease;-o-transition: all .2s ease;transition: all .2s ease;}
                    .btn-ap-group a:first-child {width: 80%;border-radius: 4px 0 0 4px;border-left: 1px solid #1978AB;}
                    .btn-ap-group a:last-child {width: 20%;border-radius: 0 4px 4px 0;border-right: 1px solid #1978AB;background: #1C85BE;} 
                    .btn-ap-group a:last-child:hover {background: #1A7BAF;color:#fff;}
                    .btn-ap-group a:first-child:hover {background: #1D8BC7;color:#fff;}
                    li.active .btn-ap-group a:first-child {background: #21A0E4;}
